...
UNDER CONSTRUCTIO - this is just a test

I love to work with data to create analysis that creates value for my customers.

Currently I work with large data sets at [Partenamut](https://www.partenamut.be) in the BI and analytics team. I administer our Tableau server, am in charge of dashboarding for different departments, text mine customer feedback, and try to the best of my abilities to predict the health expenses incured by our customers, amongst other things.
