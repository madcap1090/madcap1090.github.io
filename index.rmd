...
In my spare time I enjoy the company of my friends and family, play badminton, and like going to smaller concerts in Brussels. I am still a member of MSF and volonteer for Duo for a Job. I also continue learning machine learning. Currently I analyse Belgian politician tweets. Here is the temporary result of an anlysis of terms in tweets most helpful to determin party [membership](http://rpubs.com/madcap/reps-54), and domains [shared](http://rpubs.com/madcap/456029) to determin party affiliation. I plan to publish other interesting stuff from these sources soon.
